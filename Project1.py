...
def data_get():
    city=city_name.get()
    data = requests.get("  https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=406cd43b2b063d68d02e6601971f5f12").json()
...
#it define image.
#img= PhotoImage(file='pan.png', master= win)
...
name_label=Label(win,text="RBCET Weather App",font=("Time New Roman",30,"bold"))
name_label.place(x=25,y=50,height=50,width=450)

city_name=StringVar()
list_name=["Andhra Pradesh","Arunachal Pradesh ","Assam","Bihar","Chhattisgarh","Goa","Gujarat","Haryana","Himachal Pradesh","Jammu and Kashmir","Jharkhand","Karnataka","Kerala","Madhya Pradesh","Maharashtra","Manipur","Meghalaya","Mizoram","Nagaland","Odisha","Punjab","Rajasthan","Sikkim","Tamil Nadu","Telangana","Tripura","Uttar Pradesh","Uttarakhand","West Bengal","Andaman and Nicobar Islands","Chandigarh","Dadra and Nagar Haveli","Daman and Diu","Lakshadweep","National Capital Territory of Delhi","Puducherry"]
com = ttk.Combobox(win,text="RBMI Weather App",values=list_name,font=("Time New Roman",30,"bold"),textvariable=city_name)
...
temp_label=Label(win,text="Temparature",font=("Time New Roman",15,"bold"))
...
pre_label1=Label(win,text="",font=("Time New Roman",15,"bold"))
